        ...
        for hand_landmark in results.multi_hand_landmarks:
            ...
            #         print("FORWARD")
                    ...
                    #     print("BACKWARD")
                        ...
                        # # Left
                        # if lm_list[4].y < lm_list[2].y and lm_list[8].x < lm_list[6].x and lm_list[12].x > lm_list[
                        #     10].x and \
                        #         lm_list[16].x > lm_list[14].x and lm_list[20].x > lm_list[18].x and lm_list[5].x < \
                        #         lm_list[0].x:
